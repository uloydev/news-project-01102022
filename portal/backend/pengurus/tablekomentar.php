          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar komentar yang telah dipublikasi oleh Pengunjung</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<tr>
                      ...
                      <td>
                        <a href="editkomentar.php?id=<?php echo $p['id']; ?>" class="btn btn-warning" role="button" aria-disabled="true"><i class="fas fa-edit">&nbspEdit</i></a>
                      </td>
                       <td>
