      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
            <form class="forms-sample" action="tambah_berita.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="judul" placeholder="Masukan Nama User" type="text" name="judul" required>
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Post</label>
                <input class="form-control" id="tgl_post" placeholder="Masukan Nama User" type="date" name="tgl_post" required>
              </div>
              <div class="form-group">
                <label for="inputClientCompany">Isi Post</label>
                <textarea id="inputDescription" class="form-control" id="isi" placeholder="Isi keterangan post.." name="isi" required rows="4"></textarea>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="penulis" value="<?php echo $_SESSION['username'];?>" readonly required="required" placeholder="Ditulis oleh..">
              </div>
              <div class="form-group">
