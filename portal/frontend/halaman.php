...
<body>
    ...
    <?php
    include "koneksi.php";
    $posting = mysqli_query($koneksi, "select * from tambah_post where id='B-010' limit 1") or die(mysqli_error($koneksi));
    $comments = mysqli_query($koneksi, "select * from komentar where id_berita='B-010' and aktif = 'Y'") or die(mysqli_error($koneksi));
    $no = 1;
                    ...
                    <div class="sn-related">
                        ...
                        <form class="forms-sample" action="tambah_komentar.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="id_berita" value="<?php echo $p['id'] ?>" readonly required="required">
                            </div>
                            <button type="submit" class="btn btn-success mr-2">Tambah</button>
                        </form>
                        <h3 class="mt-5">komentar</h3>
                        <?php while ($k = mysqli_fetch_array($comments)) : ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    <blockquote class="blockquote">
                                        <p class="mb-0"><?=$k['komentar']?></p>
                                        <footer class="blockquote-footer"><cite title="Source Title"><?=$k['nama']?></cite></footer>
                                    </blockquote>
                                </div>
                            </div>
                        <?php endwhile; ?>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="contact-info">
                            <p><i class="fa fa-map-marker"></i>Cikutra, Bandung</p>
                            <p><i class="fa fa-envelope"></i>tes@gmail.com.com</p>
                            <p><i class="fa fa-phone"></i>+62xx-xxxx-xxxx</p>
                            <div class="social">
                                <a href=""><i class="fab fa-twitter"></i></a>
                                <a href=""><i class="fab fa-facebook-f"></i></a>
                                <a href=""><i class="fab fa-linkedin-in"></i></a>
